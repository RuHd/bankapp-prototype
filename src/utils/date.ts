...
// Utility function to format a date in the format DD/MM/YYYY and ensure that the day and month are valid and properly formatted with leading zeros if necessary.
